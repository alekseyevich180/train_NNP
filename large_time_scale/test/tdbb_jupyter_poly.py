...
# ============================================================
# This is a standalone single-file version. All called functions/classes are
# below in this same file. Edit CONFIG, set RUN=True, then click Run.
...
# ============================================================
# Main workflow and editable CONFIG
# ============================================================
import argparse
...
# ============================================================
# Interface bond detection/stabilization helpers
# ============================================================
...
def run(quiet: bool = QUIET, show_traceback: bool = SHOW_TRACEBACK) -> argparse.Namespace:
    args = parse_args([])
...
if RUN:
    run()
elif __name__ == "__main__" and "ipykernel" not in sys.modules and hasattr(sys.modules["__main__"], "__file__"):
    main()
